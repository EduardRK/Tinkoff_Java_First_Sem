...
public class Task9Test {
    ...
    private static Arguments @NotNull [] getArguments() {
        return new Arguments[] {
            Arguments.of(ANIMAL_LIST, 54),
            Arguments.of(List.of(FISHERON, KOKOMI, ACULA), 0)
        };
    }
    ...
    public void allPaws(List<Animal> animals, int expected) {
        Assertions.assertEquals(expected, Task9.numberOfAllPaws(animals));
    }
    ...
    public void emptyList(List<Animal> animals) {
        Assertions.assertEquals(0, Task9.numberOfAllPaws(animals));
    }
}
