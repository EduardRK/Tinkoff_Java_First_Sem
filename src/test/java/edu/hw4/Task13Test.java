...
public class Task13Test {
    ...
    @DisplayName("Animals whose name more than two words")
    public void animalsWhoseNameMoreThanTwoWords(List<Animal> animals, List<Animal> expected) {
        Assertions.assertEquals(expected, Task13.animalsWhoseNameMoreThanTwoWords(animals));
    }
}
