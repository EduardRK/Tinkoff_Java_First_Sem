...
public class Task10Test {
    ...
    private static Arguments @NotNull [] getArguments() {
        return new Arguments[] {
            Arguments.of(ANIMAL_LIST, List.of(
                KIK,
                DOGGY,
                ACULA,
                KATE,
    ...
    @DisplayName("Animals whose age not equal paws")
    public void animalsWhoseAgeNotEqualPaws(List<Animal> animals, List<Animal> expected) {
        Assertions.assertEquals(expected, Task10.animalsWhoseAgeNotEqualPaws(animals));
    }
    ...
    public void emptyList(List<Animal> animals) {
        Assertions.assertEquals(new ArrayList<>(), Task10.animalsWhoseAgeNotEqualPaws(animals));
    }
}
