...
public class Task12Test {
    ...
    @DisplayName("Count of animals whose weight greater than height")
    public void countOfAnimalsWhoseWeightGreaterThanHeight(List<Animal> animals, int expected) {
        Assertions.assertEquals(expected, Task12.countOfAnimalsWhoseWeightGreaterThanHeight(animals));
    }
}
